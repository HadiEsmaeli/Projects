...
class AdminBannerController extends Controller
{
    public function index()
    {
        ...
        return view('admin.banner.banner', compact('banner_data'));
    }
    ...
    public function update(Request $request) 
    {
        ...
        if($request->hasFile('banner_job_listing')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_job_listing));
            $ext = $request->file('banner_job_listing')->extension();
            $final_name = 'banner_job_listing'.'.'.$ext;
            $request->file('banner_job_listing')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_job_detail')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_job_detail));
            $ext = $request->file('banner_job_detail')->extension();
            $final_name = 'banner_job_detail'.'.'.$ext;
            $request->file('banner_job_detail')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_job_categories')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_job_categories));
            $ext = $request->file('banner_job_categories')->extension();
            $final_name = 'banner_job_categories'.'.'.$ext;
            $request->file('banner_job_categories')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_company_listing')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_company_listing));
            $ext = $request->file('banner_company_listing')->extension();
            $final_name = 'banner_company_listing'.'.'.$ext;
            $request->file('banner_company_listing')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_company_detail')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_company_detail));
            $ext = $request->file('banner_company_detail')->extension();
            $final_name = 'banner_company_detail'.'.'.$ext;
            $request->file('banner_company_detail')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_pricing')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_pricing));
            $ext = $request->file('banner_pricing')->extension();
            $final_name = 'banner_pricing'.'.'.$ext;
            $request->file('banner_pricing')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_blog')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_blog));
            $ext = $request->file('banner_blog')->extension();
            $final_name = 'banner_blog'.'.'.$ext;
            $request->file('banner_blog')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_post')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_post));
            $ext = $request->file('banner_post')->extension();
            $final_name = 'banner_post'.'.'.$ext;
            $request->file('banner_post')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_faq')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_faq));
            $ext = $request->file('banner_faq')->extension();
            $final_name = 'banner_faq'.'.'.$ext;
            $request->file('banner_faq')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_contact')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_contact));
            $ext = $request->file('banner_contact')->extension();
            $final_name = 'banner_contact'.'.'.$ext;
            $request->file('banner_contact')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_terms')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_terms));
            $ext = $request->file('banner_terms')->extension();
            $final_name = 'banner_terms'.'.'.$ext;
            $request->file('banner_terms')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_privacy')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_privacy));
            $ext = $request->file('banner_privacy')->extension();
            $final_name = 'banner_privacy'.'.'.$ext;
            $request->file('banner_privacy')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_signup')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_signup));
            $ext = $request->file('banner_signup')->extension();
            $final_name = 'banner_signup'.'.'.$ext;
            $request->file('banner_signup')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_login')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_login));
            $ext = $request->file('banner_login')->extension();
            $final_name = 'banner_login'.'.'.$ext;
            $request->file('banner_login')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_forget_password')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_forget_password));
            $ext = $request->file('banner_forget_password')->extension();
            $final_name = 'banner_forget_password'.'.'.$ext;
            $request->file('banner_forget_password')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_company_panel')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_company_panel));
            $ext = $request->file('banner_company_panel')->extension();
            $final_name = 'banner_company_panel'.'.'.$ext;
            $request->file('banner_company_panel')->move(public_path('uploads/banners/'),$final_name);
        ...
        if($request->hasFile('banner_candidate_panel')) {
            ...
            unlink(public_path('uploads/banners/'.$obj->banner_candidate_panel));
            $ext = $request->file('banner_candidate_panel')->extension();
            $final_name = 'banner_candidate_panel'.'.'.$ext;
            $request->file('banner_candidate_panel')->move(public_path('uploads/banners/'),$final_name);
