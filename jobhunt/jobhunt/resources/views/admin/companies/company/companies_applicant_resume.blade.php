                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset( 'uploads/candidate/profile_photos/'.$candidate_single->photo ) }}" alt="" class="w_100">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                @php $sex = $candidate_single->gender; @endphp
                                @if( $sex == 1 )
                                    <td>{{ 'Male' }}</td>
                                @else
                                    <td>{{ 'Female' }}</td>
                            ...
                            <tr>
                                ...
                                @php $marital = $candidate_single->marital_status; @endphp
                                @if( $marital == 1 )
                                    <td>{{ 'Maried' }}</td>
                                @else
                                    <td>{{ 'Unmaried' }}</td>
                            ...
                            <table class="table table-bordered table-sm">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $item->name }}</td>
                                        <td><a href="{{ asset( 'uploads/candidate/resume/' . $item->file ) }}" target="_blank">{{ $item->file }}</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
