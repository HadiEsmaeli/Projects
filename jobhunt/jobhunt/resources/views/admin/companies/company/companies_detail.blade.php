                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm">
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset( 'uploads/company/' . $companies_detail->company_logo ) }}" alt="" class="w_100">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>{{ $companies_detail->rCompanyIndustry->industry_name }}</td>
                            </tr>
                            <tr>
                                <th class="w_200">Location</th>
                                <td>{{ $companies_detail->rCompanyLocation->location }}</td>
                            </tr>
                            <tr>
                                <th class="w_200">Size</th>
                                <td>{{ $companies_detail->rCompanySize->size }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach($photos as $item)
                                        <img src="{{ asset('uploads/photos/'.$item->photo) }}" alt="" class="w_300">
                                    @endforeach
                                </td>
                            </tr>
                            <tr>
