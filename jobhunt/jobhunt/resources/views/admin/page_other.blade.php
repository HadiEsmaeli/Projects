                                    ...
                                    <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab" tabindex="0">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="login_page_meta_description"
                                                ...
                                                cols="30"
                                                rows="10"
                                            >{{ $page_other_data->login_page_meta_description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade show" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab" tabindex="0">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="signup_page_meta_description"
                                                ...
                                                cols="30"
                                                rows="10"
                                            >{{ $page_other_data->signup_page_meta_description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade show" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab" tabindex="0">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" 
                                                ...
                                                value="{{ $page_other_data->forget_password_heading }}"
                                            >
                                        </div>
                                        <h4 class="seo_section">SEO Section</h4>
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                value="{{ $page_other_data->forget_password_title }}"
                                            >
                                        </div>
                                        <div class="form-group mb-3">
                                            <label>Meta Description</label>
                                            <textarea name="forget_password_page_meta_description"
                                                ...
                                                cols="30"
                                                rows="10"
                                            >{{ $page_other_data->forget_password_meta_description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade show" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab" tabindex="0">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="job_listing_page_meta_description"
                                                ...
                                                cols="30"
                                                rows="10"
                                            >{{ $page_other_data->job_listing_page_meta_description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane fade show" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-5-tab" tabindex="0">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="company_listing_page_meta_description"
                                                ...
                                                cols="30"
                                                rows="10"
                                            >{{ $page_other_data->company_listing_page_meta_description }}</textarea>
                                        </div>
                                    </div>
