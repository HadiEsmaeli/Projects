                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ old( 'package_name' ) }}" class="form-control" name="package_name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label>Package Price *</label>
                                    <input type="text" value="{{ old( 'package_price' ) }}" class="form-control" name="package_price">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ old( 'package_days' ) }}" 
                                        class="form-control" 
                                        name="package_days"
                                    >
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ old( 'package_display_time' ) }}"
                                        class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ old( 'total_allowed_jobs' ) }}"
                                    class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ old( 'total_allowed_featured_jobs' ) }}"
                                        class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ old( 'total_allowed_photos' ) }}"
                                        class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" value="{{ old( 'total_allowed_videos' ) }}"
                                        class="form-control"
