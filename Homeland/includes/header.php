...
$categori = $select->fetchAll(PDO::FETCH_OBJ);
...
<ul class="site-menu js-clone-nav d-none d-lg-block">
  ...
  <li><a href="<?php echo APPURL; ?>type-rent-sale.php?type=sale">Buy</a></li>
  <li><a href="<?php echo APPURL; ?>type-rent-sale.php?type=rent">Rent</a></li>
  <li class="has-children">
    ...
    <ul class="dropdown arrow-top">
      ...
      <?php foreach( $categori as $category ) : ?>
        ...
        <li><a href="<?php echo APPURL; ?>categories/category.php?name=<?php echo $name; ?>"><?php echo str_replace('-', ' ', $name); ?></a></li>
      <?php endforeach; ?>
  ...
  <?php if( isset( $_SESSION['username'] ) ) : ?>
    <li class="has-children">
      ...
      <ul class="dropdown arrow-top">
        ...
        <li><a href="<?php echo APPURL; ?>user/requests.php">Request</a></li>
