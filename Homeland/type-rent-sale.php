...
if( isset( $_GET['type'] ) AND !empty( $_GET['type'] ) ){
    ...
    $id = $_GET['type'];
    $rent = $conn->prepare("SELECT * FROM `props` WHERE `type` = :rent");
    $rent->execute([ ':rent' => $id ]);

    $allrent = $rent->fetchAll(PDO::FETCH_OBJ);
}else{
            ...
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              ...
              <div class="ml-auto d-flex align-items-center">
                <div>
                  ...
                  <a href="type-rent-sale.php?id=rent" class="view-list px-3 border-right">Rent</a>
                  <a href="type-rent-sale.php?id=sale" class="view-list px-3">Sale</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <?php foreach( $allrent as $rent ) : ?>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
              <div class="property-entry h-100">
                <a href="property-details.php?id=<?php echo $rent->id; ?>" class="property-thumbnail">
                  <div class="offer-type-wrap">
                    <span class="offer-type bg-<?php if( $rent->type == 'rent' ) {echo 'success';}else{echo 'danger';} ?>"><?php echo $rent->type; ?></span>
                  </div>
                  <img src="images/<?php echo $rent->image; ?>" alt="Image" class="img-fluid">
                </a>
                <div class="p-4 property-body">
                  <h2 class="property-title"><a href="property-details.php?id=<?php echo $rent->id; ?>"><?php echo $rent->name; ?></a></h2>
                  <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span><?php echo $rent->location; ?></span>
                  <strong class="property-price text-primary mb-3 d-block text-success"><?php echo number_format($rent->price); ?></strong>
                  <ul class="property-specs-wrap mb-3 mb-lg-0">
                    <li>
                      <span class="property-specs">Beds</span>
                      <span class="property-specs-number"><?php echo $rent->beds; ?><sup>+</sup></span>
                      
                    </li>
                    <li>
                      <span class="property-specs">Baths</span>
                      <span class="property-specs-number"><?php echo $rent->bath; ?></span>
                      
                    </li>
                    <li>
                      <span class="property-specs">SQ FT</span>
                      <span class="property-specs-number"><?php echo $rent->sqft; ?></span>
